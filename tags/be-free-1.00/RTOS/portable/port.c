...
AT91PS_PITC pxPIT = AT91C_BASE_PITC;
	...
	pxPIT->PITC_PIMR = portPIT_ENABLE | portPIT_INT_ENABLE | portPIT_COUNTER_VALUE;
        AT91C_BASE_RTTC->RTTC_RTMR  = (AT91C_RTTC_RTPRES & 0x8000) | AT91C_RTTC_RTTINCIEN;      // Interrupt on increment every 1sec.
        AT91C_BASE_RTTC->RTTC_RTMR |= AT91C_RTTC_RTTRST;                                        // Start timer.

        extern void (spurious_irq_handler)(void);
        AT91C_BASE_AIC->AIC_SPU = (void *) spurious_irq_handler;                                // Call this handler for spurious irq.
